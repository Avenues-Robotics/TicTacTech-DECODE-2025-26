...
@Config
@Autonomous(name = "AutoOpModularBlueFar", group = "Main")
public class AutoOpModularBlueFar extends LinearOpMode {
    ...
    public static double AIM_F = 0.09;
    ...
    public static double adjustment = 10;
    ...
    public static AutoStep step02 = new AutoStep(MoveType.WAIT, 500, 1);
    public static AutoStep step03 = new AutoStep(MoveType.FEED, 5000, 1);
